...
```{r, fig.height=6, fig.width=12, message=FALSE}
  require(Discriminability)
  inpath <- 'C:/Users/ebrid/Documents/R/fngs_merge/BNU1/roi_timeseries/HarvardOxford-cort-maxprob-thr25-2mm/'
...
ggplot(new, aes(x=postprocessing, y=discr, color=dataset)) +
  geom_point(size=4) +
  ggtitle('Discriminability of CPAC vs FNGS')
```
